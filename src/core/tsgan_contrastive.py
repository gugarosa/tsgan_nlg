"""Text-Similarity Generative Adversarial Network with Contrastive Loss-based Discriminator.
"""
...
class TSGANContrastive(Adversarial):
    """A TSGANContrastive class is the one in charge of Text-Similarity Generative Adversarial Networks
    implementation with contrastive loss-based discriminator.
